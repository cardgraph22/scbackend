...
//console.log('import getUsers', getUsers)
//console.log('call getUsers', await getUsers())
...
{#each await getUsers() as { username, email, imagename, _id }}
      
      <div class="p-0.5 text-gray-700 text-left">{username}</div>
      <div class="p-0.5 text-gray-700 text-left">{email}</div>
      
      
      <div class="p-0.5 text-gray-700 text-left">{imagename}</div>
